...
func schema_pkg_apis_travis_v1_AppService(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_travis_v1_AppServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_travis_v1_AppServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
